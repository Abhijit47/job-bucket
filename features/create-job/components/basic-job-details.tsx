...
type BasicDetailsType = z.infer<typeof basicDetails>;

export default function BasicDetails() {
  const form = useForm<BasicDetailsType>({
  ...
  const errorHandler: SubmitErrorHandler<BasicDetailsType> = (errors) => {
    console.log('Form Errors:', errors);
  };

  const submitHandler: SubmitHandler<BasicDetailsType> = (data) => {
  ...
  return (
    <Card className={''}>
      <CardContent className={''}>
        <form onSubmit={form.handleSubmit(submitHandler, errorHandler)}>
          <FieldDemo />
        </form>
      </CardContent>
    </Card>
