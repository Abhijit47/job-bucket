...
const siteMetadata: Metadata = {
  ...
  authors: [
    { name: 'JobWeez Team', url: `${process.env.BETTER_AUTH_URL}/about` },
  ],
  generator: 'Next.js',
  keywords: [
    'job search',
  ...
  alternates: {
    ...
    languages: {
      'en-US': `${process.env.BETTER_AUTH_URL}/en-US`,
    },
  },
  icons: `${process.env.BETTER_AUTH_URL}/icon.png`,
  manifest: `${process.env.BETTER_AUTH_URL}/manifest.json`,
  openGraph: {
    determiner: 'the',
    title: 'JobWeez',
    description:
  ...
  twitter: {
    ...
    site: '@site',
    creator: '@creator',
    images: `${process.env.BETTER_AUTH_URL}/og.png`,
  },
  ...
  assets: `${process.env.BETTER_AUTH_URL}/assets`,
  bookmarks: `${process.env.BETTER_AUTH_URL}/bookmarks`,
